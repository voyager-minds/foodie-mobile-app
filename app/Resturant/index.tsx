...
import { restaurantStyles as styles } from "./styles";
  ...
  const fetchReviews = useCallback(
    async (page = 1) => {
      ...
      try {
        ...
        setReviewsTotalPages(reviewsData.totalPages || Math.max(1, Math.ceil(reviewItems.length / 10)));
      } catch (err) {
    ...
    return (
      ...
      >
        <View style={styles.menuImageWrap}>
          <Image
            source={{
              uri: getImageUrl(item.images && item.images.length > 0 ? item.images[0] : undefined)
            }}
    ...
    <View style={styles.screen}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ paddingBottom: 40 }}>
        <View style={styles.headerImageWrap}>
          <Image
            source={{ uri: getImageUrl(restaurant.coverImage || restaurant.coverImageKey || restaurant.coverImageUrl) }}
            ...
            {restaurant.avgOverall ? (
              <View style={styles.ratingWrap}>
                ...
                <Text style={styles.ratingText}>
                  {restaurant.avgOverall.toFixed(1)} ({restaurant.countReviews || 0})
                </Text>
              </View>
            ) : null}
      ...
      <Modal visible={showMenuModal} animationType="slide" transparent>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <TouchableOpacity style={styles.modalClose} onPress={closeMenuItemModal}>
                ...
                <View style={{ padding: 12 }}>
                  <View style={styles.modalHeader}>
                    ...
                    <Text style={styles.modalPrice}>
                      {formatMenuPrice(selectedMenuItem.priceCents, selectedMenuItem.currency)}
                    </Text>
                  </View>
                  ...
                  {selectedMenuItem.description ? (
                    <Text style={styles.modalDesc}>{selectedMenuItem.description}</Text>
                  ) : null}

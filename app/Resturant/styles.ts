...
export const restaurantStyles = StyleSheet.create({
  ...
  tag: { backgroundColor: colors.primaryLight, paddingVertical: 4, paddingHorizontal: 8, borderRadius: 16, marginRight: 6, marginBottom: 6 },
  ...
  viewAllBtn: { flexDirection: "row", alignItems: "center", paddingHorizontal: 8, paddingVertical: 4 },
  viewAllText: { color: colors.primary, fontWeight: "600", marginRight: 4 },

  // Menu card
  menuCard: { flexDirection: "row", backgroundColor: colors.white, borderRadius: 10, marginBottom: 12, overflow: "hidden", elevation: 2 },
  menuCardUnavailable: { opacity: 0.6 },
  menuImageWrap: { width: 120, height: 100 },
  menuImage: { width: "100%", height: "100%" },
  availabilityBadge: { position: "absolute", bottom: 6, left: 6, backgroundColor: colors.overlayDark, paddingHorizontal: 6, paddingVertical: 3, borderRadius: 6, flexDirection: "row", alignItems: "center" },
  ...
  viewDetailsBtn: { backgroundColor: colors.primary, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6 },
  ...
  // Reviews
  reviewCard: { backgroundColor: colors.white, borderRadius: 10, padding: 12, marginBottom: 10, elevation: 1 },
  reviewHeader: { flexDirection: "row", alignItems: "center" },
  reviewerAvatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.avatar, justifyContent: "center", alignItems: "center" },
  ...
  replySection: { marginTop: 10, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 10 },
  commentsList: { marginBottom: 8 },
  commentItem: { marginBottom: 8, backgroundColor: colors.gray50, padding: 8, borderRadius: 8 },
  commentHeader: { flexDirection: "row", justifyContent: "space-between", marginBottom: 6 },
  commentAuthor: { fontWeight: "700" },
  commentDate: { color: colors.textTertiary, fontSize: 12 },
  commentText: { color: colors.textPrimary },

  commentInput: { borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: 8, backgroundColor: colors.white, marginBottom: 8 },

  postReplyBtn: { alignSelf: "flex-end", backgroundColor: colors.primary, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8 },
  disabledBtn: { opacity: 0.5 },
  postReplyText: { color: colors.white, fontWeight: "700" },

  // pagination
  pagination: { flexDirection: "row", justifyContent: "center", alignItems: "center", gap: 10, marginTop: 10 },
  pageButton: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 6, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.borderLight },
  pageButtonText: { color: colors.textPrimary, fontWeight: "600" },
  pageInfo: { marginHorizontal: 12 },

  // FAB
  fab: { position: "absolute", right: 18, bottom: 24, width: 52, height: 52, borderRadius: 26, backgroundColor: colors.primary, justifyContent: "center", alignItems: "center", elevation: 6 },

  // Modal
  modalOverlay: { flex: 1, backgroundColor: colors.overlay, justifyContent: "center", alignItems: "center", padding: 16 },
  modalContainer: { width: "100%", maxHeight: "85%", backgroundColor: colors.white, borderRadius: 12, overflow: "hidden" },
  ...
  modalActionBtn: { marginTop: 14, backgroundColor: colors.primary, padding: 12, borderRadius: 8, alignItems: "center" },
  modalActionText: { color: colors.white, fontWeight: "700" },

  addReviewModal: { width: "100%", backgroundColor: colors.white, padding: 16, borderRadius: 12 },
  submitReviewBtn: { backgroundColor: colors.primary, padding: 12, borderRadius: 8, marginRight: 8 },
  submitReviewText: { color: colors.white, fontWeight: "700" },

  addReviewBtn: { marginTop: 10, backgroundColor: colors.primary, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8 },
  addReviewText: { color: colors.white, fontWeight: "700" },

  starInput: { width: 36, height: 36, borderWidth: 1, borderColor: colors.borderLight, borderRadius: 6, paddingHorizontal: 8 },
});